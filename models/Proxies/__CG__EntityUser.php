...
class User extends \Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\User' . "\0" . 'id', '' . "\0" . 'Entity\\User' . "\0" . 'email', '' . "\0" . 'Entity\\User' . "\0" . 'password', '' . "\0" . 'Entity\\User' . "\0" . 'role', '' . "\0" . 'Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'Entity\\User' . "\0" . 'imgUrl', '' . "\0" . 'Entity\\User' . "\0" . 'isConfirmed', '' . "\0" . 'Entity\\User' . "\0" . 'person');
        }
