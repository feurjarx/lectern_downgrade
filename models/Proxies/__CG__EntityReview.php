 ...
 */
class Review extends \Entity\Review implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Review' . "\0" . 'id', '' . "\0" . 'Entity\\Review' . "\0" . 'title', '' . "\0" . 'Entity\\Review' . "\0" . 'description', '' . "\0" . 'Entity\\Review' . "\0" . 'publishedAt', '' . "\0" . 'Entity\\Review' . "\0" . 'rating', '' . "\0" . 'Entity\\Review' . "\0" . 'user');
        }
